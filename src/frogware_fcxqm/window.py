...
class MainWindow_Ui(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout.setWidget(
            0, QtWidgets.QFormLayout.FieldRole, self.le_step_size_um)
        ...
        self.formLayout.setWidget(
            1, QtWidgets.QFormLayout.FieldRole, self.le_step_size_fs)
        ...
        self.formLayout_2.setWidget(
            0, QtWidgets.QFormLayout.FieldRole, self.le_pos_um)
        ...
        self.formLayout_2.setWidget(
            1, QtWidgets.QFormLayout.FieldRole, self.le_pos_fs)
        ...
        self.lcd_cnt_update_current_pos_um = QtWidgets.QLCDNumber(
            self.groupBox_2)
        self.lcd_cnt_update_current_pos_um.setObjectName(
            "lcd_cnt_update_current_pos_um")
        ...
        self.lcd_cnt_update_current_pos_fs = QtWidgets.QLCDNumber(
            self.groupBox_2)
        self.lcd_cnt_update_current_pos_fs.setObjectName(
            "lcd_cnt_update_current_pos_fs")
        ...
        self.groupBox_5.setMaximumSize(QtCore.QSize(232, 329))
        ...
        spacerItem17 = QtWidgets.QSpacerItem(
            37, 17, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.formLayout_5.setWidget(
            0, QtWidgets.QFormLayout.LabelRole, self.label_21)
        ...
        self.formLayout_5.setWidget(
            0, QtWidgets.QFormLayout.FieldRole, self.le_tab2_step_size_um)
        self.label_22 = QtWidgets.QLabel(self.groupBox_5)
        self.label_22.setObjectName("label_22")
        self.formLayout_5.setWidget(
            1, QtWidgets.QFormLayout.LabelRole, self.label_22)
        ...
        self.formLayout_5.setWidget(
            1, QtWidgets.QFormLayout.FieldRole, self.le_tab2_step_size_fs)
        ...
        self.formLayout_4.setWidget(
            0, QtWidgets.QFormLayout.FieldRole, self.le_start_um)
        self.label_14 = QtWidgets.QLabel(self.groupBox_5)
        self.label_14.setObjectName("label_14")
        self.formLayout_4.setWidget(
            1, QtWidgets.QFormLayout.LabelRole, self.label_14)
        ...
        self.formLayout_4.setWidget(
            1, QtWidgets.QFormLayout.FieldRole, self.le_start_fs)
        ...
        self.formLayout_3.setWidget(
            0, QtWidgets.QFormLayout.LabelRole, self.label_15)
        ...
        self.formLayout_3.setWidget(
            0, QtWidgets.QFormLayout.FieldRole, self.le_end_um)
        self.label_16 = QtWidgets.QLabel(self.groupBox_5)
        self.label_16.setObjectName("label_16")
        self.formLayout_3.setWidget(
            1, QtWidgets.QFormLayout.LabelRole, self.label_16)
        ...
        self.formLayout_3.setWidget(
            1, QtWidgets.QFormLayout.FieldRole, self.le_end_fs)
        ...
        self.btn_plot_autocorrelation = QtWidgets.QPushButton(self.groupBox_5)
        self.btn_plot_autocorrelation.setObjectName("btn_plot_autocorrelation")
        self.horizontalLayout_17.addWidget(self.btn_plot_autocorrelation)
        ...
        self.horizontalLayout_18.addWidget(self.groupBox1)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/Open/open_icon.png"),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen.setIcon(icon)
        self.actionOpen.setObjectName("actionOpen")
        self.actionSave = QtWidgets.QAction(MainWindow)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/Save/save_icon.jpg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave.setIcon(icon1)
        self.actionSave.setObjectName("actionSave")
        self.actionStop = QtWidgets.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/Stop/stop_icon.jpg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_17.setText(_translate(
            "MainWindow", "Current Position (um)"))
        self.label_19.setText(_translate(
            "MainWindow", "Current Position (fs)"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.tab), _translate("MainWindow", "Spectrum Continuous Update"))
        ...
        self.label_20.setText(_translate(
            "MainWindow", "Current Position (fs)"))
        self.btn_plot_autocorrelation.setText(_translate("MainWindow", "plot intensity \n"
                                                         "  autocorrelation"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.tab_2), _translate("MainWindow", "Spectrogram"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.tab_3), _translate("MainWindow", "Settings"))
